"""Module providing unit conversion functionality.
...
Notes
-----
Conversion factors taken from Perry's Chemical Engineer's Handbook.
...
TEMPERATURE = {
    "F": lambda t: (t - 32.0) * 5.0 / 9.0 + 273.15,
    "R": lambda t: t / 1.8,
    "C": lambda t: t + 273.15,
    "K": lambda t: t,
}
...
def to_si(value: float, unit: str) -> float:
    ...
    :param value: Input value to be converted to corresponding SI value.
    :type price: float
    :param unit: Unit of input value.
    :type price: str
    :return: Value converted to corresponding SI unit.
    :rtype: float
    :raises ValueError: If the unit is not defined.
    """
    if unit in UNITS:
...
def to_si_unit(unit: str) -> str:
    """Lookup corresponding SI value.

    :param unit: Input unit for lookup to corresponding SI unit.
    :type price: str
    :return: Corresponding SI unit.
    :rtype: str
    :raises ValueError: If the unit is not defined.
    """
